"""
Django settings for hawkward_store project.
...
ROOT_URLCONF = 'hawkward_store.urls'
...
WSGI_APPLICATION = 'hawkward_store.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'hawkward-store'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'hawkward-store@example.com'
else:
